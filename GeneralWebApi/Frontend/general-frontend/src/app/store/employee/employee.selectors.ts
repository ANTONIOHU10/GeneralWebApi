...
export const selectFilteredEmployees = createSelector(
  ...
  (employees, filters) => {
    ...
    // 排序
    filtered.sort((a, b) => {
      const aValue = getNestedValue(a as unknown as Record<string, unknown>, filters.sortBy);
      const bValue = getNestedValue(b as unknown as Record<string, unknown>, filters.sortBy);
...
export const selectIsEmployeeLoading = (operation?: 'create' | 'update' | 'delete') => createSelector(
