...
export class BreadcrumbComponent implements OnInit {
  ...
  private routeMap: Record<string, BreadcrumbItem[]> = {
    '/private/dashboard': [{ label: 'Dashboard', icon: 'dashboard' }],
    '/private/tasks': [{ label: 'Tasks', icon: 'task_alt' }],
    '/private/approvals': [{ label: 'My Approvals', icon: 'approval' }],
