        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsManagement = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Italia"),
                    ...
                    LastSalaryIncreaseDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssuingPlace = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    IssuingCountry = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    IssuingState = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedFromIp = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certifications_IssuingOrganization",
                table: "Certifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeRoles_ExpiryDate",
                table: "EmployeeRoles",
                column: "ExpiryDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdentityDocuments_DocumentType",
                table: "IdentityDocuments",
                column: "DocumentType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdentityDocuments_ExpirationDate",
                table: "IdentityDocuments",
                column: "ExpirationDate");

            migrationBuilder.CreateIndex(
                name: "IX_IdentityDocuments_IssuingAuthority",
                table: "IdentityDocuments",
                column: "IssuingAuthority");

            migrationBuilder.CreateIndex(
                name: "IX_IdentityDocuments_IssuingCountry",
                table: "IdentityDocuments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Positions_IsManagement",
                table: "Positions",
                column: "IsManagement");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermissions_ExpiryDate",
