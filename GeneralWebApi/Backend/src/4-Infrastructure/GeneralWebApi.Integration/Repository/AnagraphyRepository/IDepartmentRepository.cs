...
public interface IDepartmentRepository : IBaseRepository<Department>
{
    ...
    Task<PagedResult<Department>> GetPagedAsync(int pageNumber, int pageSize, string? searchTerm = null, int? parentDepartmentId = null, int? level = null, string? name = null, string? code = null, string? description = null, string? sortBy = null, bool sortDescending = false, CancellationToken cancellationToken = default);
