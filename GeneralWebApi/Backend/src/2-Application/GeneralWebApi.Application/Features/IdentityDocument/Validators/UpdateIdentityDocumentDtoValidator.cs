...
public class UpdateIdentityDocumentDtoValidator : AbstractValidator<UpdateIdentityDocumentDto>
{
    public UpdateIdentityDocumentDtoValidator()
    {
        RuleFor(x => x.Id)
            .GreaterThan(0)
            .WithMessage("Identity document ID must be greater than 0");
