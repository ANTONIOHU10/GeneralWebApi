...
public class DepartmentSearchDtoValidator : AbstractValidator<DepartmentSearchDto>
{
    public DepartmentSearchDtoValidator()
    {
    ...
    private static bool BeValidSortField(string? sortBy)
    {
        ...
        var validFields = new[] { "Name", "Code", "Level", "CreatedAt" };
